...
import '../../features/auth/data/data_sources/auth_remote_data_soruce.dart'
    as _i47;
import '../../features/auth/data/repositories/auth_repo_impl.dart' as _i88;
import '../../features/auth/domain/repositories/auth_repo.dart' as _i87;
...
import '../../features/auth/domain/use_cases/get_remember_login_email_usecase.dart'
    as _i15;
import '../../features/auth/domain/use_cases/login_usecase.dart' as _i89;
...
import '../../features/auth/domain/use_cases/qr_barcode_reader_login_usecase.dart'
    as _i90;
import '../../features/auth/domain/use_cases/sign_up_usecase.dart' as _i91;
import '../../features/auth/presentation/bloc/login/login_bloc.dart' as _i92;
...
import '../../features/common/presentation/bloc/address_input_bloc/address_input_bloc.dart'
    as _i86;
import '../../features/common/presentation/bloc/user/user_bloc.dart' as _i84;
...
import '../../features/shop/presentation/bloc/product_properties_input/product_properties_input_bloc.dart'
    as _i76;
import '../../features/shop/presentation/bloc/shop/shop_bloc.dart' as _i80;
...
import '../../features/shopping_cart/presentation/bloc/shopping_cart_bloc.dart'
    as _i83;
import '../../shared/bloc/image_input/image_input_bloc.dart' as _i70;
import 'injection.dart' as _i94; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i48.CreateProductBatchesUseCase>(
      () => _i48.CreateProductBatchesUseCase(get<_i39.WarehouseRepo>()));
  gh.lazySingleton<_i49.CreateProductImagesUseCase>(
      () => _i49.CreateProductImagesUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i50.CreateProductUseCase>(
      () => _i50.CreateProductUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i51.CreateWarehouseInputUseCase>(
      () => _i51.CreateWarehouseInputUseCase(get<_i39.WarehouseRepo>()));
  gh.lazySingleton<_i52.DeleteCartItemsUseCase>(
      () => _i52.DeleteCartItemsUseCase(get<_i31.ShoppingCartRepo>()));
  gh.lazySingleton<_i53.DeleteProductUseCase>(
      () => _i53.DeleteProductUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i54.GetCommunesAndWardsUseCase>(
      () => _i54.GetCommunesAndWardsUseCase(get<_i42.AddressRepo>()));
  gh.lazySingleton<_i55.GetDistrictsUseCase>(
      () => _i55.GetDistrictsUseCase(get<_i42.AddressRepo>()));
  gh.lazySingleton<_i56.GetHomeBannersUseCase>(
      () => _i56.GetHomeBannersUseCase(get<_i45.AdsRepo>()));
  gh.lazySingleton<_i57.GetMyAddressesUseCase>(
      () => _i57.GetMyAddressesUseCase(get<_i42.AddressRepo>()));
  gh.lazySingleton<_i58.GetProductCateByIdUseCase>(
      () => _i58.GetProductCateByIdUseCase(get<_i21.ProductCateRepo>()));
  gh.lazySingleton<_i59.GetProductCatesUseCase>(
      () => _i59.GetProductCatesUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i60.GetProductDetailUseCase>(
      () => _i60.GetProductDetailUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i61.GetProductInventoryUseCase>(
      () => _i61.GetProductInventoryUseCase(get<_i39.WarehouseRepo>()));
  gh.lazySingleton<_i62.GetProductsUseCase>(
      () => _i62.GetProductsUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i63.GetPropertyTemplateOfCateUseCase>(
      () => _i63.GetPropertyTemplateOfCateUseCase(get<_i24.ProductRepo>()));
  gh.lazySingleton<_i64.GetProvincesAndCitiesUseCase>(
      () => _i64.GetProvincesAndCitiesUseCase(get<_i42.AddressRepo>()));
  gh.lazySingleton<_i65.GetShoppingCartByIdUseCase>(
      () => _i65.GetShoppingCartByIdUseCase(get<_i31.ShoppingCartRepo>()));
  gh.lazySingleton<_i66.GetShoppingCartUseCase>(
      () => _i66.GetShoppingCartUseCase(get<_i31.ShoppingCartRepo>()));
  gh.lazySingleton<_i67.GetUserDetailUseCase>(
      () => _i67.GetUserDetailUseCase(get<_i36.UserRepo>()));
  gh.lazySingleton<_i68.GetWarehousesUseCase>(
      () => _i68.GetWarehousesUseCase(get<_i39.WarehouseRepo>()));
  gh.lazySingleton<_i69.HomeBloc>(() => _i69.HomeBloc(
        get<_i62.GetProductsUseCase>(),
        get<_i59.GetProductCatesUseCase>(),
        get<_i56.GetHomeBannersUseCase>(),
      ));
  gh.lazySingleton<_i70.ImageInputBloc>(
      () => _i70.ImageInputBloc(get<_i19.PickLocalImageAsBase64UseCase>()));
  gh.lazySingleton<_i71.ProductBatchInputBloc>(
      () => _i71.ProductBatchInputBloc(get<_i60.GetProductDetailUseCase>()));
  gh.lazySingleton<_i72.ProductCateInputBloc>(() => _i72.ProductCateInputBloc(
        get<_i59.GetProductCatesUseCase>(),
        get<_i58.GetProductCateByIdUseCase>(),
      ));
  gh.lazySingleton<_i73.ProductDetailBloc>(
      () => _i73.ProductDetailBloc(get<_i60.GetProductDetailUseCase>()));
  gh.lazySingleton<_i74.ProductInventoryBloc>(
      () => _i74.ProductInventoryBloc(get<_i61.GetProductInventoryUseCase>()));
  gh.lazySingleton<_i75.ProductInventoryInputBloc>(
    () => _i75.ProductInventoryInputBloc(
      get<_i62.GetProductsUseCase>(),
      get<_i51.CreateWarehouseInputUseCase>(),
      get<_i48.CreateProductBatchesUseCase>(),
      get<_i68.GetWarehousesUseCase>(),
    ),
    dispose: (i) => i.close(),
  );
  gh.lazySingleton<_i76.ProductPropertiesInputBloc>(() =>
      _i76.ProductPropertiesInputBloc(
          get<_i63.GetPropertyTemplateOfCateUseCase>()));
  gh.lazySingleton<_i77.RegisterShopUseCase>(
      () => _i77.RegisterShopUseCase(get<_i28.ShopRepo>()));
  gh.lazySingleton<_i78.SaveMyAddressUseCase>(
      () => _i78.SaveMyAddressUseCase(get<_i42.AddressRepo>()));
  gh.lazySingleton<_i79.SearchProductsBloc>(() => _i79.SearchProductsBloc(
        get<_i26.SearchProductsUserCase>(),
        get<_i62.GetProductsUseCase>(),
      ));
  gh.lazySingleton<_i80.ShopBloc>(
      () => _i80.ShopBloc(get<_i77.RegisterShopUseCase>()));
  gh.lazySingleton<_i81.ShopProductBloc>(() => _i81.ShopProductBloc(
        get<_i62.GetProductsUseCase>(),
        get<_i59.GetProductCatesUseCase>(),
        get<_i56.GetHomeBannersUseCase>(),
        get<_i53.DeleteProductUseCase>(),
      ));
  gh.lazySingleton<_i82.ShopProductDetailBloc>(
    () => _i82.ShopProductDetailBloc(
      get<_i60.GetProductDetailUseCase>(),
      get<_i50.CreateProductUseCase>(),
      get<_i49.CreateProductImagesUseCase>(),
      get<_i33.UpdateProductUseCase>(),
    ),
    dispose: (i) => i.close(),
  );
  gh.lazySingleton<_i83.ShoppingCartBloc>(() => _i83.ShoppingCartBloc(
        get<_i66.GetShoppingCartUseCase>(),
        get<_i34.UpsertCartItemUseCase>(),
        get<_i52.DeleteCartItemsUseCase>(),
      ));
  gh.lazySingleton<_i84.UserBloc>(
      () => _i84.UserBloc(get<_i67.GetUserDetailUseCase>()));
  gh.factory<_i85.AddressBloc>(() => _i85.AddressBloc(
        get<_i57.GetMyAddressesUseCase>(),
        get<_i64.GetProvincesAndCitiesUseCase>(),
        get<_i55.GetDistrictsUseCase>(),
        get<_i54.GetCommunesAndWardsUseCase>(),
      ));
  gh.lazySingleton<_i86.AddressInputBloc>(
      () => _i86.AddressInputBloc(get<_i78.SaveMyAddressUseCase>()));
  gh.lazySingleton<_i87.AuthRepo>(
      () => _i88.AuthRepoImpl(get<_i47.AuthRepoteDatasource>()));
  gh.lazySingleton<_i89.EmailLoginUseCase>(() => _i89.EmailLoginUseCase(
        get<_i87.AuthRepo>(),
        get<_i11.Storage>(),
      ));
  gh.lazySingleton<_i90.QrBarcodeLoginUseCase>(() => _i90.QrBarcodeLoginUseCase(
        get<_i87.AuthRepo>(),
        get<_i89.EmailLoginUseCase>(),
      ));
  gh.lazySingleton<_i91.SignUpUseCase>(
      () => _i91.SignUpUseCase(get<_i87.AuthRepo>()));
  gh.lazySingleton<_i92.LoginBloc>(() => _i92.LoginBloc(
        get<_i89.EmailLoginUseCase>(),
        get<_i90.QrBarcodeLoginUseCase>(),
        get<_i13.CheckLoginUseCase>(),
        get<_i17.LogoutUseCase>(),
        get<_i15.GetRememberLoginEmailUserCase>(),
      ));
  gh.lazySingleton<_i93.SignUpBloc>(
      () => _i93.SignUpBloc(get<_i91.SignUpUseCase>()));
  return get;
}

class _$AppModuleDepedenciesProvider
    extends _i94.AppModuleDepedenciesProvider {}
