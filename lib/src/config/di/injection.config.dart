...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i19.PushNotificationBloc>(
        () => _i19.PushNotificationBloc(gh<_i7.PushNotificationUseCases>()));
    gh.lazySingleton<_i20.PickLocalImageAsBase64UseCase>(() =>
        _i20.PickLocalImageAsBase64UseCase(gh<_i16.PickLocalImageUseCase>()));
    gh.lazySingleton<_i21.ApiInterceptor>(
        () => _i21.ApiInterceptor(gh<_i4.Storage>()));
    gh.lazySingleton<_i22.LogoutUseCase>(
        () => _i22.LogoutUseCase(gh<_i4.Storage>()));
    gh.lazySingleton<_i23.CheckLoginUseCase>(
        () => _i23.CheckLoginUseCase(gh<_i4.Storage>()));
    gh.lazySingleton<_i24.GetRememberLoginEmailUserCase>(
        () => _i24.GetRememberLoginEmailUserCase(gh<_i4.Storage>()));
    gh.lazySingleton<_i25.SignalRBloc>(
        () => _i25.SignalRBloc(gh<_i4.Storage>()));
    gh.lazySingleton<_i26.LogoutUseCase>(
        () => _i26.LogoutUseCase(gh<_i4.Storage>()));
    gh.lazySingleton<_i27.GetRememberLoginEmailUserCase>(
        () => _i27.GetRememberLoginEmailUserCase(gh<_i4.Storage>()));
    gh.lazySingleton<_i28.MainBloc>(() => _i28.MainBloc(gh<_i4.Storage>()));
    gh.lazySingleton<_i29.ImageInputBloc>(
        () => _i29.ImageInputBloc(gh<_i20.PickLocalImageAsBase64UseCase>()));
    gh.singleton<_i30.Dio>(() => appModuleDepedenciesProvider
        .provideNetworkDio(gh<_i21.ApiInterceptor>()));
    gh.singleton<_i31.PaymentDatasource>(() =>
        paymentDatasourceProvider.providePaymentDatasource(gh<_i30.Dio>()));
    gh.singleton<_i32.OrderDatasource>(
        () => orderDatasourceProvider.provideOrderDatasource(gh<_i30.Dio>()));
    gh.singleton<_i33.AuthRepoteDatasource>(() => authRepoteDatasourceProvider
        .provideAuthRepoteDatasource(gh<_i30.Dio>()));
    gh.singleton<_i34.NotificationDatasource>(() =>
        notificationDatasourceProvider
            .provideNotificationDatasource(gh<_i30.Dio>()));
    gh.singleton<_i35.ShopRemoteDatasource>(() => shopRepoteDatasourceProvider
        .provideShopRepoteDatasource(gh<_i30.Dio>()));
    gh.singleton<_i36.WarehouseRemoteDatasource>(() =>
        warehouseRemoteDatasourceProvider
            .provideWarehouseRemoteDatasource(gh<_i30.Dio>()));
    gh.singleton<_i37.AdsDatasource>(
        () => adsDatasourceProvider.provideAdsDatasource(gh<_i30.Dio>()));
    gh.singleton<_i38.ProductCateDatasource>(() => productCateDatasourceProvider
        .provideProductCateDatasource(gh<_i30.Dio>()));
    gh.singleton<_i39.ProductRemoteDatasource>(() =>
        productRemoteDatasourceProvider
            .provideProductRemoteDatasource(gh<_i30.Dio>()));
    gh.singleton<_i40.AddressDatasource>(() =>
        addressDatasourceProvider.provideAddressDatasource(gh<_i30.Dio>()));
    gh.singleton<_i41.UserDatasource>(
        () => userDatasourceProvider.provideUserDatasource(gh<_i30.Dio>()));
    gh.singleton<_i42.ShoppingCartDatasource>(() =>
        shoppingCartDatasourceProvider
            .provideShoppingCartDatasource(gh<_i30.Dio>()));
    gh.lazySingleton<_i43.AuthRepo>(
        () => _i44.AuthRepoImpl(gh<_i33.AuthRepoteDatasource>()));
    gh.lazySingleton<_i45.NotificationRepo>(
        () => _i46.NotificationRepoImpl(gh<_i34.NotificationDatasource>()));
    gh.lazySingleton<_i47.AddressRepo>(
        () => _i48.AddressRepoImpl(gh<_i40.AddressDatasource>()));
    gh.lazySingleton<_i49.GetProvincesAndCitiesUseCase>(
        () => _i49.GetProvincesAndCitiesUseCase(gh<_i47.AddressRepo>()));
    gh.lazySingleton<_i50.GetMyAddressesUseCase>(
        () => _i50.GetMyAddressesUseCase(gh<_i47.AddressRepo>()));
    gh.lazySingleton<_i51.GetDistrictsUseCase>(
        () => _i51.GetDistrictsUseCase(gh<_i47.AddressRepo>()));
    gh.lazySingleton<_i52.SaveMyAddressUseCase>(
        () => _i52.SaveMyAddressUseCase(gh<_i47.AddressRepo>()));
    gh.lazySingleton<_i53.GetCommunesAndWardsUseCase>(
        () => _i53.GetCommunesAndWardsUseCase(gh<_i47.AddressRepo>()));
    gh.lazySingleton<_i54.EmailLoginUseCase>(() => _i54.EmailLoginUseCase(
          gh<_i43.AuthRepo>(),
          gh<_i4.Storage>(),
        ));
    gh.lazySingleton<_i55.SignUpUseCase>(
        () => _i55.SignUpUseCase(gh<_i43.AuthRepo>()));
    gh.lazySingleton<_i56.ShopRepo>(
        () => _i57.ShopRepoImpl(gh<_i35.ShopRemoteDatasource>()));
    ...
    gh.lazySingleton<_i59.QrBarcodeLoginUseCase>(
        () => _i59.QrBarcodeLoginUseCase(
              gh<_i43.AuthRepo>(),
              gh<_i54.EmailLoginUseCase>(),
            ));
    gh.lazySingleton<_i60.AdsRepo>(
        () => _i61.AdsRepoImpl(gh<_i37.AdsDatasource>()));
    gh.lazySingleton<_i62.CreateNotificationReceiverUseCase>(() =>
        _i62.CreateNotificationReceiverUseCase(gh<_i45.NotificationRepo>()));
    gh.lazySingleton<_i63.GetNotificationsUseCase>(
        () => _i63.GetNotificationsUseCase(gh<_i45.NotificationRepo>()));
    ...
    gh.lazySingleton<_i65.GetHomeBannersUseCase>(
        () => _i65.GetHomeBannersUseCase(gh<_i60.AdsRepo>()));
    gh.lazySingleton<_i66.PaymentRepo>(
        () => _i67.PaymentRepoImpl(gh<_i31.PaymentDatasource>()));
    gh.lazySingleton<_i68.ProductRepo>(
        () => _i69.ProductRepoImpl(gh<_i39.ProductRemoteDatasource>()));
    gh.lazySingleton<_i70.CreateProductUseCase>(
        () => _i70.CreateProductUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i71.UpdateProductUseCase>(
        () => _i71.UpdateProductUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i72.DeleteProductUseCase>(
        () => _i72.DeleteProductUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i73.SearchProductsUserCase>(
        () => _i73.SearchProductsUserCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i74.GetProductCatesUseCase>(
        () => _i74.GetProductCatesUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i75.GetProductsUseCase>(
        () => _i75.GetProductsUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i76.GetProductDetailUseCase>(
        () => _i76.GetProductDetailUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i77.CreateProductImagesUseCase>(
        () => _i77.CreateProductImagesUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i78.GetPropertyTemplateOfCateUseCase>(
        () => _i78.GetPropertyTemplateOfCateUseCase(gh<_i68.ProductRepo>()));
    gh.lazySingleton<_i79.ShoppingCartRepo>(
        () => _i80.ShoppingCartRepoImpl(gh<_i42.ShoppingCartDatasource>()));
    gh.lazySingleton<_i81.WarehouseRepo>(
        () => _i82.WarehouseRepoImpl(gh<_i36.WarehouseRemoteDatasource>()));
    ...
    gh.lazySingleton<_i84.ProductCateRepo>(
        () => _i85.ProductRepoImpl(gh<_i38.ProductCateDatasource>()));
    gh.lazySingleton<_i86.UserRepo>(
        () => _i87.UserRepoImpl(gh<_i41.UserDatasource>()));
    ...
    gh.lazySingleton<_i89.ProductDetailBloc>(
        () => _i89.ProductDetailBloc(gh<_i76.GetProductDetailUseCase>()));
    gh.lazySingleton<_i90.FCMBloc>(() => _i90.FCMBloc(
          gh<_i62.CreateNotificationReceiverUseCase>(),
          gh<_i8.FCMNotificationsUseCases>(),
        ));
    gh.lazySingleton<_i91.OrderRepo>(
        () => _i92.OrderRepoImpl(gh<_i32.OrderDatasource>()));
    gh.lazySingleton<_i93.GetProductInventoryUseCase>(
        () => _i93.GetProductInventoryUseCase(gh<_i81.WarehouseRepo>()));
    gh.lazySingleton<_i94.GetWarehousesUseCase>(
        () => _i94.GetWarehousesUseCase(gh<_i81.WarehouseRepo>()));
    ...
    gh.lazySingleton<_i99.GetOrdersUseCase>(
        () => _i99.GetOrdersUseCase(gh<_i91.OrderRepo>()));
    gh.lazySingleton<_i100.CreateOrderUseCase>(
        () => _i100.CreateOrderUseCase(gh<_i91.OrderRepo>()));
    gh.lazySingleton<_i101.StartProcessingOrderUseCase>(
        () => _i101.StartProcessingOrderUseCase(gh<_i91.OrderRepo>()));
    ...
    gh.lazySingleton<_i104.RegisterShopUseCase>(
        () => _i104.RegisterShopUseCase(gh<_i56.ShopRepo>()));
    gh.lazySingleton<_i105.ShopBloc>(
        () => _i105.ShopBloc(gh<_i104.RegisterShopUseCase>()));
    gh.lazySingleton<_i106.GetUserDetailUseCase>(
        () => _i106.GetUserDetailUseCase(gh<_i86.UserRepo>()));
    ...
    gh.lazySingleton<_i109.SignUpBloc>(
        () => _i109.SignUpBloc(gh<_i55.SignUpUseCase>()));
    ...
    gh.lazySingleton<_i112.UpsertCartItemUseCase>(
        () => _i112.UpsertCartItemUseCase(gh<_i79.ShoppingCartRepo>()));
    gh.lazySingleton<_i113.DeleteCartItemsUseCase>(
        () => _i113.DeleteCartItemsUseCase(gh<_i79.ShoppingCartRepo>()));
    gh.lazySingleton<_i114.GetShoppingCartByIdUseCase>(
        () => _i114.GetShoppingCartByIdUseCase(gh<_i79.ShoppingCartRepo>()));
    gh.lazySingleton<_i115.GetShoppingCartUseCase>(
        () => _i115.GetShoppingCartUseCase(gh<_i79.ShoppingCartRepo>()));
    gh.lazySingleton<_i116.ProductPropertiesInputBloc>(() =>
        _i116.ProductPropertiesInputBloc(
            gh<_i78.GetPropertyTemplateOfCateUseCase>()));
    gh.lazySingleton<_i117.GetPaymentMethodsUseCase>(
        () => _i117.GetPaymentMethodsUseCase(gh<_i66.PaymentRepo>()));
    ...
    gh.lazySingleton<_i123.ShopOrderBloc>(
        () => _i123.ShopOrderBloc(gh<_i99.GetOrdersUseCase>()));
    ...
    gh.lazySingleton<_i125.UserBloc>(
        () => _i125.UserBloc(gh<_i106.GetUserDetailUseCase>()));
