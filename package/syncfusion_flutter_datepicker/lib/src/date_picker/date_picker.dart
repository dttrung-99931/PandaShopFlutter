...
String _getMonthHeaderText(
  ...
  if ((!isHijri && numberOfWeeksInView != 6) &&
    ...
    final String startText =
        // ignore: lines_longer_than_80_chars
        '${dates[startIndex].year}年 ${DateFormat(monthTextFormat, locale.toString()).format(dates[startIndex])}';
    final String endText =
        // ignore: lines_longer_than_80_chars
        '${dates[endIndex].year}年 ${DateFormat(monthTextFormat, locale.toString()).format(dates[endIndex])}';
    ...
    if (isHijri) {
      ...
      text =
          // ignore: lines_longer_than_80_chars
          '${middleDate.year}年 ${DateFormat(monthTextFormat, locale.toString()).format(middleDate)}';
    }
