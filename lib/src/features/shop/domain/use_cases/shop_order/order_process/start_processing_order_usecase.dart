...
@lazySingleton
class StartProcessingOrderUseCase extends EitherUseCase<dynamic, int> {
  final OrderRepo _repo;
  StartProcessingOrderUseCase(this._repo);

  @override
  Future<Either<Failure, dynamic>> call(int orderId) {
    return handleRepoResult(
      repoResult: _repo.startProcessingOrder(orderId),
