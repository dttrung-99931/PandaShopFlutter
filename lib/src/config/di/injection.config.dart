...
import 'package:evievm_app/src/features/panvideo/data/data_sources/panvideo_data_source.dart'
    as _i116;
import 'package:evievm_app/src/features/panvideo/data/repositories/panmusic_repo_impl.dart'
    as _i298;
import 'package:evievm_app/src/features/panvideo/data/repositories/panvideo_editor_repo_impl.dart'
    as _i589;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i147.DownloadFileUseCase>(
        () => _i147.DownloadFileUseCase());
    ...
    gh.lazySingleton<_i339.PanVideoEditorRepo>(
        () => _i589.FFmpegPanvideoEditorRepoImpl());
    ...
    gh.lazySingleton<_i82.EditPanVideoUsecase>(
        () => _i82.EditPanVideoUsecase(repo: gh<_i339.PanVideoEditorRepo>()));
    ...
    gh.singleton<_i188.PanMusicDatasource>(() =>
        panMusicDatasourceProvider.providePanMusicDatasource(gh<_i361.Dio>()));
    ...
    gh.lazySingleton<_i592.PanMusicRepo>(
        () => _i298.PanMusicRepoImpl(gh<_i188.PanMusicDatasource>()));
    ...
    gh.lazySingleton<_i309.GetPanMusicsUseCase>(
        () => _i309.GetPanMusicsUseCase(gh<_i592.PanMusicRepo>()));
    ...
    gh.lazySingleton<_i482.PanMusicBloc>(
        () => _i482.PanMusicBloc(gh<_i309.GetPanMusicsUseCase>()));
