...
OrderResponseModel _$OrderResponseModelFromJson(Map<String, dynamic> json) => OrderResponseModel(
      ...
      orderDetails: (json['orderDetails'] as List<dynamic>)
          ...
          .toList(),
      customerAddress: AddressModel.fromJson(json['deliveryAddress'] as Map<String, dynamic>),
    );
...
OrderDetailResponseModel _$OrderDetailResponseModelFromJson(Map<String, dynamic> json) => OrderDetailResponseModel(
      id: (json['id'] as num).toInt(),
...
ShortOrderDetailResponseModel _$ShortOrderDetailResponseModelFromJson(Map<String, dynamic> json) =>
