...
import '../../features/auth/data/data_sources/auth_remote_data_soruce.dart'
    as _i57;
import '../../features/auth/data/repositories/auth_repo_impl.dart' as _i106;
import '../../features/auth/domain/repositories/auth_repo.dart' as _i105;
...
import '../../features/auth/domain/use_cases/get_remember_login_email_usecase.dart'
    as _i18;
import '../../features/auth/domain/use_cases/login_usecase.dart' as _i107;
...
import '../../features/auth/domain/use_cases/qr_barcode_reader_login_usecase.dart'
    as _i108;
import '../../features/auth/domain/use_cases/sign_up_usecase.dart' as _i109;
import '../../features/auth/presentation/bloc/login/login_bloc.dart' as _i110;
...
import '../../features/common/data/data_sources/address_data_soruce.dart'
    as _i51;
import '../../features/common/data/data_sources/user_data_source.dart' as _i45;
import '../../features/common/data/repos/address_repo_impl.dart' as _i53;
import '../../features/common/data/repos/user_repo_impl.dart' as _i47;
import '../../features/common/domain/repos/address_repo.dart' as _i52;
import '../../features/common/domain/repos/user_repo.dart' as _i46;
...
import '../../features/common/presentation/bloc/main/main_bloc_communicaton.dart'
    as _i4;
import '../../features/common/presentation/bloc/user/user_bloc.dart' as _i102;
import '../../features/home/presentation/bloc/home_bloc.dart' as _i83;
...
import '../../features/order/domain/use_cases/create_order_usecase.dart'
    as _i59;
import '../../features/order/domain/use_cases/get_orders_usecase.dart' as _i70;
...
import '../../features/order/presentation/bloc/delivery_method_inp/delivery_method_inp_bloc.dart'
    as _i3;
import '../../features/order/presentation/bloc/order_bloc.dart' as _i85;
...
import '../../features/product/data/data_sources/product_remote_data_soruce.dart'
    as _i32;
import '../../features/product/data/repos/ads_repo_impl.dart' as _i56;
...
import '../../features/product/domain/repos/ads_repo.dart' as _i55;
...
import '../../features/shop/data/repositories/warehouse_repo_impl.dart' as _i50;
import '../../features/shop/domain/repositories/shop_repo.dart' as _i37;
import '../../features/shop/domain/repositories/warehouse_repo.dart' as _i49;
...
import '../../features/shop/presentation/bloc/product_properties_input/product_properties_input_bloc.dart'
    as _i93;
import '../../features/shop/presentation/bloc/shop/shop_bloc.dart' as _i97;
...
import '../../features/shopping_cart/presentation/bloc/shopping_cart_bloc.dart'
    as _i101;
import '../../shared/bloc/image_input/image_input_bloc.dart' as _i84;
import 'injection.dart' as _i112; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i42.StartProcessingOrderUseCase>(
      () => _i42.StartProcessingOrderUseCase(get<_i23.OrderRepo>()));
  gh.lazySingleton<_i43.UpdateProductUseCase>(
      () => _i43.UpdateProductUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i44.UpsertCartItemUseCase>(
      () => _i44.UpsertCartItemUseCase(get<_i40.ShoppingCartRepo>()));
  gh.singleton<_i45.UserDatasource>(
      userDatasourceProvider.provideUserDatasource(get<_i16.Dio>()));
  gh.lazySingleton<_i46.UserRepo>(
      () => _i47.UserRepoImpl(get<_i45.UserDatasource>()));
  gh.singleton<_i48.WarehouseRemoteDatasource>(warehouseRemoteDatasourceProvider
      .provideWarehouseRemoteDatasource(get<_i16.Dio>()));
  gh.lazySingleton<_i49.WarehouseRepo>(
      () => _i50.WarehouseRepoImpl(get<_i48.WarehouseRemoteDatasource>()));
  gh.singleton<_i51.AddressDatasource>(
      addressDatasourceProvider.provideAddressDatasource(get<_i16.Dio>()));
  gh.lazySingleton<_i52.AddressRepo>(
      () => _i53.AddressRepoImpl(get<_i51.AddressDatasource>()));
  gh.singleton<_i54.AdsDatasource>(
      adsDatasourceProvider.provideAdsDatasource(get<_i16.Dio>()));
  gh.lazySingleton<_i55.AdsRepo>(
      () => _i56.AdsRepoImpl(get<_i54.AdsDatasource>()));
  gh.singleton<_i57.AuthRepoteDatasource>(authRepoteDatasourceProvider
      .provideAuthRepoteDatasource(get<_i16.Dio>()));
  gh.lazySingleton<_i58.CompleteProcessingOrderUseCase>(
      () => _i58.CompleteProcessingOrderUseCase(get<_i23.OrderRepo>()));
  gh.lazySingleton<_i59.CreateOrderUseCase>(
      () => _i59.CreateOrderUseCase(get<_i23.OrderRepo>()));
  gh.lazySingleton<_i60.CreateProductBatchesUseCase>(
      () => _i60.CreateProductBatchesUseCase(get<_i49.WarehouseRepo>()));
  gh.lazySingleton<_i61.CreateProductImagesUseCase>(
      () => _i61.CreateProductImagesUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i62.CreateProductUseCase>(
      () => _i62.CreateProductUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i63.CreateWarehouseInputUseCase>(
      () => _i63.CreateWarehouseInputUseCase(get<_i49.WarehouseRepo>()));
  gh.lazySingleton<_i64.DeleteCartItemsUseCase>(
      () => _i64.DeleteCartItemsUseCase(get<_i40.ShoppingCartRepo>()));
  gh.lazySingleton<_i65.DeleteProductUseCase>(
      () => _i65.DeleteProductUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i66.GetCommunesAndWardsUseCase>(
      () => _i66.GetCommunesAndWardsUseCase(get<_i52.AddressRepo>()));
  gh.lazySingleton<_i67.GetDistrictsUseCase>(
      () => _i67.GetDistrictsUseCase(get<_i52.AddressRepo>()));
  gh.lazySingleton<_i68.GetHomeBannersUseCase>(
      () => _i68.GetHomeBannersUseCase(get<_i55.AdsRepo>()));
  gh.lazySingleton<_i69.GetMyAddressesUseCase>(
      () => _i69.GetMyAddressesUseCase(get<_i52.AddressRepo>()));
  gh.lazySingleton<_i70.GetOrdersUseCase>(
      () => _i70.GetOrdersUseCase(get<_i23.OrderRepo>()));
  gh.lazySingleton<_i71.GetPaymentMethodsUseCase>(
      () => _i71.GetPaymentMethodsUseCase(get<_i26.PaymentRepo>()));
  gh.lazySingleton<_i72.GetProductCateByIdUseCase>(
      () => _i72.GetProductCateByIdUseCase(get<_i30.ProductCateRepo>()));
  gh.lazySingleton<_i73.GetProductCatesUseCase>(
      () => _i73.GetProductCatesUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i74.GetProductDetailUseCase>(
      () => _i74.GetProductDetailUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i75.GetProductInventoryUseCase>(
      () => _i75.GetProductInventoryUseCase(get<_i49.WarehouseRepo>()));
  gh.lazySingleton<_i76.GetProductsUseCase>(
      () => _i76.GetProductsUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i77.GetPropertyTemplateOfCateUseCase>(
      () => _i77.GetPropertyTemplateOfCateUseCase(get<_i33.ProductRepo>()));
  gh.lazySingleton<_i78.GetProvincesAndCitiesUseCase>(
      () => _i78.GetProvincesAndCitiesUseCase(get<_i52.AddressRepo>()));
  gh.lazySingleton<_i79.GetShoppingCartByIdUseCase>(
      () => _i79.GetShoppingCartByIdUseCase(get<_i40.ShoppingCartRepo>()));
  gh.lazySingleton<_i80.GetShoppingCartUseCase>(
      () => _i80.GetShoppingCartUseCase(get<_i40.ShoppingCartRepo>()));
  gh.lazySingleton<_i81.GetUserDetailUseCase>(
      () => _i81.GetUserDetailUseCase(get<_i46.UserRepo>()));
  gh.lazySingleton<_i82.GetWarehousesUseCase>(
      () => _i82.GetWarehousesUseCase(get<_i49.WarehouseRepo>()));
  gh.lazySingleton<_i83.HomeBloc>(() => _i83.HomeBloc(
        get<_i76.GetProductsUseCase>(),
        get<_i73.GetProductCatesUseCase>(),
        get<_i68.GetHomeBannersUseCase>(),
      ));
  gh.lazySingleton<_i84.ImageInputBloc>(
      () => _i84.ImageInputBloc(get<_i28.PickLocalImageAsBase64UseCase>()));
  gh.lazySingleton<_i85.OrderBloc>(
    () => _i85.OrderBloc(get<_i59.CreateOrderUseCase>()),
    dispose: (i) => i.close(),
  );
  gh.lazySingleton<_i86.OrderProcessBloc>(() => _i86.OrderProcessBloc(
        get<_i42.StartProcessingOrderUseCase>(),
        get<_i58.CompleteProcessingOrderUseCase>(),
      ));
  gh.lazySingleton<_i87.PaymentMethodInpBloc>(
      () => _i87.PaymentMethodInpBloc(get<_i71.GetPaymentMethodsUseCase>()));
  gh.lazySingleton<_i88.ProductBatchInputBloc>(
      () => _i88.ProductBatchInputBloc(get<_i74.GetProductDetailUseCase>()));
  gh.lazySingleton<_i89.ProductCateInputBloc>(() => _i89.ProductCateInputBloc(
        get<_i73.GetProductCatesUseCase>(),
        get<_i72.GetProductCateByIdUseCase>(),
      ));
  gh.lazySingleton<_i90.ProductDetailBloc>(
      () => _i90.ProductDetailBloc(get<_i74.GetProductDetailUseCase>()));
  gh.lazySingleton<_i91.ProductInventoryBloc>(
      () => _i91.ProductInventoryBloc(get<_i75.GetProductInventoryUseCase>()));
  gh.lazySingleton<_i92.ProductInventoryInputBloc>(
    () => _i92.ProductInventoryInputBloc(
      get<_i76.GetProductsUseCase>(),
      get<_i63.CreateWarehouseInputUseCase>(),
      get<_i60.CreateProductBatchesUseCase>(),
      get<_i82.GetWarehousesUseCase>(),
    ),
    dispose: (i) => i.close(),
  );
  gh.lazySingleton<_i93.ProductPropertiesInputBloc>(() =>
      _i93.ProductPropertiesInputBloc(
          get<_i77.GetPropertyTemplateOfCateUseCase>()));
  gh.lazySingleton<_i94.RegisterShopUseCase>(
      () => _i94.RegisterShopUseCase(get<_i37.ShopRepo>()));
  gh.lazySingleton<_i95.SaveMyAddressUseCase>(
      () => _i95.SaveMyAddressUseCase(get<_i52.AddressRepo>()));
  gh.lazySingleton<_i96.SearchProductsBloc>(() => _i96.SearchProductsBloc(
        get<_i35.SearchProductsUserCase>(),
        get<_i76.GetProductsUseCase>(),
      ));
  gh.lazySingleton<_i97.ShopBloc>(
      () => _i97.ShopBloc(get<_i94.RegisterShopUseCase>()));
  gh.lazySingleton<_i98.ShopOrderBloc>(
      () => _i98.ShopOrderBloc(get<_i70.GetOrdersUseCase>()));
  gh.lazySingleton<_i99.ShopProductBloc>(() => _i99.ShopProductBloc(
        get<_i76.GetProductsUseCase>(),
        get<_i73.GetProductCatesUseCase>(),
        get<_i68.GetHomeBannersUseCase>(),
        get<_i65.DeleteProductUseCase>(),
      ));
  gh.lazySingleton<_i100.ShopProductDetailBloc>(
    () => _i100.ShopProductDetailBloc(
      get<_i74.GetProductDetailUseCase>(),
      get<_i62.CreateProductUseCase>(),
      get<_i61.CreateProductImagesUseCase>(),
      get<_i43.UpdateProductUseCase>(),
    ),
    dispose: (i) => i.close(),
  );
  gh.lazySingleton<_i101.ShoppingCartBloc>(() => _i101.ShoppingCartBloc(
        get<_i80.GetShoppingCartUseCase>(),
        get<_i44.UpsertCartItemUseCase>(),
        get<_i64.DeleteCartItemsUseCase>(),
      ));
  gh.lazySingleton<_i102.UserBloc>(
      () => _i102.UserBloc(get<_i81.GetUserDetailUseCase>()));
  gh.factory<_i103.AddressBloc>(() => _i103.AddressBloc(
        get<_i69.GetMyAddressesUseCase>(),
        get<_i78.GetProvincesAndCitiesUseCase>(),
        get<_i67.GetDistrictsUseCase>(),
        get<_i66.GetCommunesAndWardsUseCase>(),
      ));
  gh.lazySingleton<_i104.AddressInputBloc>(
      () => _i104.AddressInputBloc(get<_i95.SaveMyAddressUseCase>()));
  gh.lazySingleton<_i105.AuthRepo>(
      () => _i106.AuthRepoImpl(get<_i57.AuthRepoteDatasource>()));
  gh.lazySingleton<_i107.EmailLoginUseCase>(() => _i107.EmailLoginUseCase(
        get<_i105.AuthRepo>(),
        get<_i13.Storage>(),
      ));
  gh.lazySingleton<_i108.QrBarcodeLoginUseCase>(
      () => _i108.QrBarcodeLoginUseCase(
            get<_i105.AuthRepo>(),
            get<_i107.EmailLoginUseCase>(),
          ));
  gh.lazySingleton<_i109.SignUpUseCase>(
      () => _i109.SignUpUseCase(get<_i105.AuthRepo>()));
  gh.lazySingleton<_i110.LoginBloc>(() => _i110.LoginBloc(
        get<_i107.EmailLoginUseCase>(),
        get<_i108.QrBarcodeLoginUseCase>(),
        get<_i15.CheckLoginUseCase>(),
        get<_i20.LogoutUseCase>(),
        get<_i18.GetRememberLoginEmailUserCase>(),
      ));
  gh.lazySingleton<_i111.SignUpBloc>(
      () => _i111.SignUpBloc(get<_i109.SignUpUseCase>()));
  return get;
}

class _$AppModuleDepedenciesProvider
    extends _i112.AppModuleDepedenciesProvider {}
...
class _$WarehouseRemoteDatasourceProvider
    extends _i48.WarehouseRemoteDatasourceProvider {}

class _$AddressDatasourceProvider extends _i51.AddressDatasourceProvider {}

class _$AdsDatasourceProvider extends _i54.AdsDatasourceProvider {}

class _$AuthRepoteDatasourceProvider
    extends _i57.AuthRepoteDatasourceProvider {}
