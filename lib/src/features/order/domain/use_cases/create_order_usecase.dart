...
@lazySingleton
class CreateOrderUseCase extends EitherUseCase<dynamic, CreateOrdersRequestModel> {
  final OrderRepo _repo;

  CreateOrderUseCase(this._repo);

  @override
  Future<Either<Failure, dynamic>> call(CreateOrdersRequestModel params) async {
